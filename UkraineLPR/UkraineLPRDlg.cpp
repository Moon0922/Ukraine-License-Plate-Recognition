...
// UkraineLPRDlg.cpp : implementation file
//

#include "pch.h"
#include "framework.h"
#include "UkraineLPR.h"
#include "UkraineLPRDlg.h"
...
// CUkraineLPRDlg dialog


#include "Page_ImageWnd.h"
#include "Page_VideoWnd.h"
CUkraineLPRDlg::CUkraineLPRDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_UKRAINELPR_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CUkraineLPRDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CUkraineLPRDlg, CDialogEx)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_CREATE()
	ON_WM_SIZE()
...
// CUkraineLPRDlg message handlers

BOOL CUkraineLPRDlg::OnInitDialog()
{
...
HCURSOR CUkraineLPRDlg::OnQueryDragIcon()
{
...
int CUkraineLPRDlg::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CUkraineLPRDlg::OnSize(UINT nType, int cx, int cy)
{
...
LRESULT CUkraineLPRDlg::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
...
BOOL CUkraineLPRDlg::PreTranslateMessage(MSG* pMsg)
{
	// TODO: Add your specialized code here and/or call the base class
